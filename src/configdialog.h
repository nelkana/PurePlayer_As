...
inline ConfigDialog::ConfigDialog(QWidget* parent) : QDialog(parent)
{
    setupUi(this);
...
inline void ConfigDialog::setData(ConfigData::Data* data)
{
    if( data == NULL ) return;
...
inline void ConfigDialog::apply()
{
    bool restart = false;
    QString driverName;
...
inline void ConfigDialog::setScreenshotPathFromDialog()
{
...
inline void ConfigDialog::setMplayerPathFromDialog()
{
...
inline void ConfigDialog::showEvent(QShowEvent*)
{
    setFixedSize(size());
